...
class DownloadVideoJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            if (File::exists($outputPath)) {
                ...
                // LOG UNTUK ADMIN: Berhasil download
                SystemLog::create([
                    'service'  => 'YT-DLP',
                    'level'    => 'INFO',
                    'category' => 'DOWNLOAD',
                    'user_id'  => $this->video->user_id,
                    'message'  => "Berhasil mengunduh video dari sumber.",
                    'payload'  => ['url' => $this->video->source_url, 'video_id' => $this->video->id]
                ]);
            ...
            // LOG UNTUK ADMIN: Gagal download (Penting untuk deteksi link mati/copyright)
            SystemLog::create([
                'service'  => 'YT-DLP',
                'level'    => 'ERROR',
                'category' => 'DOWNLOAD',
                'user_id'  => $this->video->user_id,
                'message'  => "Gagal mengunduh video: " . $e->getMessage(),
                'payload'  => ['url' => $this->video->source_url, 'video_id' => $this->video->id]
            ]);
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        // LOG UNTUK ADMIN: Job gagal permanen setelah retry
        SystemLog::create([
            'service'  => 'SYSTEM',
            'level'    => 'ERROR',
            'category' => 'DOWNLOAD',
            'user_id'  => $this->video->user_id,
            'message'  => "Job Download gagal permanen setelah percobaan ulang.",
